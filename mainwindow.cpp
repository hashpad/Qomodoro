...
MainWindow::MainWindow(QWidget *parent)
  ...
  connect(pref, &Preferences::update_stopwatch, this,
          &MainWindow::update_stopwatch);
...
bool MainWindow::init_db() {
  ...
  this->db = new Database(this, cacheLocation + "/pomodoro.db");
  return this->db->init();
}
